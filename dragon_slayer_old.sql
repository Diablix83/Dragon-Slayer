...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 04 Septembre 2017 à 20:21
...
--
-- Structure de la table `project001_armors_pieces`
--

CREATE TABLE `project001_armors_pieces` (
  `id` int(11) NOT NULL,
...
--
-- Contenu de la table `project001_armors_pieces`
--

INSERT INTO `project001_armors_pieces` (`id`, `name`, `emplacement`, `type`, `ratio`) VALUES
(1, 'Tête nue', 'head', 13, 1),
(2, 'Torse nue', 'torso', 13, 5),
(3, 'Mains nues', 'hands', 13, 1),
(4, 'Jambes nues', 'legs', 13, 2),
(5, 'Pieds nues', 'foot', 13, 1),
(6, 'Casque matelassé', 'head', 1, 1),
(7, 'Chemise matelassée', 'torso', 1, 5),
(8, 'Gants matelassées', 'hands', 1, 1),
(9, 'Jambières matelassées', 'legs', 1, 2),
(10, 'Bottes matelassées', 'foot', 1, 1);

-- --------------------------------------------------------

--
-- Structure de la table `project001_armors_type`
--

CREATE TABLE `project001_armors_type` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
...
--
-- Contenu de la table `project001_armors_type`
--

INSERT INTO `project001_armors_type` (`id`, `name`, `defense`, `dodge`, `speed`) VALUES
...
--
-- Structure de la table `project001_class_armors_type`
--

CREATE TABLE `project001_class_armors_type` (
  `id` int(11) NOT NULL,
  `class` int(11) NOT NULL,
...
--
-- Contenu de la table `project001_class_armors_type`
--

INSERT INTO `project001_class_armors_type` (`id`, `class`, `armor`) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 1, 3),
(4, 1, 4),
...
--
-- Index pour la table `project001_armors_pieces`
--
ALTER TABLE `project001_armors_pieces`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `project001_armors_type`
--
ALTER TABLE `project001_armors_type`
  ADD PRIMARY KEY (`id`),
...
--
-- Index pour la table `project001_class_armors_type`
--
ALTER TABLE `project001_class_armors_type`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT pour la table `project001_armors_pieces`
--
ALTER TABLE `project001_armors_pieces`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT pour la table `project001_armors_type`
--
ALTER TABLE `project001_armors_type`
...
--
-- AUTO_INCREMENT pour la table `project001_class_armors_type`
--
ALTER TABLE `project001_class_armors_type`
